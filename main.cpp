...
int main()
{
    ...
    Triangle_file="Triangles.dat";
    Triangle_file2="Triangles2.dat";
    Triangle_file3="Triangles3.dat";
    Triangle_file4="Triangles4.dat";
    Triangle_file5="Triangles5.dat";
    Triangle_fileDyk="TrianglesDyk.dat";
    outfile="Grand_Canyon.png";
    ...
    {   tritr5=The_Triangle.begin();
        advance (tritr5,5);
        fout << ' ' << *tritr << ' ' << *tritr4<< ' ' << *tritr4<<endl;
        fout << ' ' << *tritr5<< ' ' << *tritr4<< ' ' << *tritr4<<endl<<endl;
        fout << ' ' << *tritr<< ' ' << *tritr<< ' ' << *tritr4<<endl;
        fout << ' ' << *tritr5<< ' ' << *tritr<< ' ' << *tritr4<<endl;}
        fout<<endl;
        The_Triangle.clear();
        j++;
    }
    ...
    {///start for loop for loading lists for left lower tier
        ...
        The_Triangle.push_back(x=gen()%5+33);
        The_Triangle.push_back(T.YLL2()*j);
        The_Triangle.push_back(T.Z2());
        The_Triangle.push_back(x=gen()%10+1);
    ...
    {///start for loop for loading lists for right lower tier
        ...
        The_Triangle.push_back(x=gen()%4+40);
